            ...
            $.ajax({
                ...
                success : function(data){
                    if(data.status === 0)
                    {
                        ...
                        var transactionsSum = $("#transactions-sum");
                        var transactionsSumValue = parseFloat(transactionsSum.html());
                        transactionsSum.html(transactionsSumValue - parseFloat(data.transaction_amount));
...
$("#city_id").change(function () {
    ...
    var url = window.laravelUrl + "/api/regions-not-paginated?city_id=" + city_id;
    $.ajax({
        url: url,
        type: 'get',
        dataType: 'json',
